...
## Gnome::Gio::N-FileAttributeInfoList

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-GFileAttributeInfoList.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-GFileAttributeInfoList.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-GFileAttributeInfoList.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gfileattributeinfolist |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add |![](/content-docs/asset_files/images/checklist-implement.png)|||
| dup |![](/content-docs/asset_files/images/checklist-implement.png)|||
| lookup |![](/content-docs/asset_files/images/checklist-implement.png)|||
