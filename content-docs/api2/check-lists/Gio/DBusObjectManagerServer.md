...
## Gnome::Gio::DBusObjectManagerServer

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|DBusObjectManagerServer.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|DBusObjectManagerServer.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|DBusObjectManagerServer.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gdbusobjectmanagerserver |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
...
| export-uniquely |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| get-connection |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| is-exported |![](/content-docs/asset_files/images/checklist-implement.png)| 2.34 ||
| set-connection |![](/content-docs/asset_files/images/checklist-implement.png)|||
