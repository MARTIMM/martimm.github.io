...
## Gnome::Gio::BufferedInputStream

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|BufferedInputStream.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|BufferedInputStream.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|BufferedInputStream.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gbufferedinputstream |![](/content-docs/asset_files/images/checklist-implement.png)|||
| new-sized |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| fill |![](/content-docs/asset_files/images/checklist-implement.png)|||
| fill-async |![](/content-docs/asset_files/images/checklist-implement.png)|||
| fill-finish |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-available |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-buffer-size |![](/content-docs/asset_files/images/checklist-implement.png)|||
| peek |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
| peek-buffer |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
| read-byte |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-buffer-size |![](/content-docs/asset_files/images/checklist-implement.png)|||
