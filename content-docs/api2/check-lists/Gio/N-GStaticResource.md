...
## Gnome::Gio::N-StaticResource

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-GStaticResource.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-GStaticResource.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-GStaticResource.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| fini |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| get-resource |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| init |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
