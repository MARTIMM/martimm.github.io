...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|R-ListModel.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-ok.png)|R-ListModel.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-ok.png)|R-ListModel.rakutest|2 tests|

<br/><strong>Note:</strong> Most tests are done in Gtk4 StringList.rakutest

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-item |![](/content-docs/asset_files/images/checklist-no-implement.png)| 2.44 ||
| get-item-type |![](/content-docs/asset_files/images/checklist-ok.png)| 2.44 ||
| get-n-items |![](/content-docs/asset_files/images/checklist-ok.png)| 2.44 ||
| get-object |![](/content-docs/asset_files/images/checklist-ok.png)| 2.44 ||
| items-changed |![](/content-docs/asset_files/images/checklist-ok.png)| 2.44 ||

<br/>method **get-item**: Removed because get-object() is a better choice
