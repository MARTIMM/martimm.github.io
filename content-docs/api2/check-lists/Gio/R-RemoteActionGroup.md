...
## Gnome::Gio::R-RemoteActionGroup

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|R-RemoteActionGroup.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-RemoteActionGroup.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|R-RemoteActionGroup.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| activate-action-full |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| change-action-state-full |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
