...
## Gnome::Gio::N-SrvTarget

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-GSrvTarget.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-GSrvTarget.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-GSrvTarget.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gsrvtarget |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| copy |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| free |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| get-hostname |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| get-port |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| get-priority |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| get-weight |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| list-sort |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
