...
## Gnome::Gio::UnixConnection

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|UnixConnection.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|UnixConnection.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|UnixConnection.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| receive-credentials |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| receive-credentials-async |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| receive-credentials-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| receive-fd |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| send-credentials |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| send-credentials-async |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| send-credentials-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| send-fd |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||

<br/>

1. Status, generated, missing values, deprecated, etc
2. Version of introduction, otherwise it is the release version (2.22)
