...
## Gnome::Gio::SettingsBackend

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SettingsBackend.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SettingsBackend.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SettingsBackend.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| changed |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| changed-tree |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| keys-changed |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| path-changed |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| path-writable-changed |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| writable-changed |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| flatten-tree |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
