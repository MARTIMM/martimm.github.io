...
## Gnome::Gio::FileMonitor

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|FileMonitor.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|FileMonitor.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|FileMonitor.rakutest|0 tests|
...
| emit-event |![](/content-docs/asset_files/images/checklist-implement.png)|||
| is-cancelled |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-rate-limit |![](/content-docs/asset_files/images/checklist-implement.png)|||
