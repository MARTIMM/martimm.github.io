...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Vfs.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Vfs.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Vfs.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-file-for-path |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-file-for-uri |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-supported-uri-schemes |![](/content-docs/asset_files/images/checklist-implement.png)|||
| is-active |![](/content-docs/asset_files/images/checklist-implement.png)|||
| parse-name |![](/content-docs/asset_files/images/checklist-implement.png)|||
| register-uri-scheme |![](/content-docs/asset_files/images/checklist-implement.png)| 2.50 ||
| unregister-uri-scheme |![](/content-docs/asset_files/images/checklist-implement.png)| 2.50 ||
...
| get-local |![](/content-docs/asset_files/images/checklist-implement.png)|||
