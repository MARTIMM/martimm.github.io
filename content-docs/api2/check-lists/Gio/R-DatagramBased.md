...
## Gnome::Gio::R-DatagramBased

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|R-DatagramBased.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-DatagramBased.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|R-DatagramBased.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| condition-check |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 2.48 ||
| condition-wait |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 2.48 ||
| create-source |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 2.48 ||
| receive-messages |![](/content-docs/asset_files/images/checklist-implement.png)| 2.48 ||
| send-messages |![](/content-docs/asset_files/images/checklist-implement.png)| 2.48 ||
