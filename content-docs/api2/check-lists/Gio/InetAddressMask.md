...
## Gnome::Gio::InetAddressMask

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|InetAddressMask.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|InetAddressMask.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|InetAddressMask.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-from-string |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| new-ginetaddressmask |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| equal |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| get-address |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| get-family |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| get-length |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| matches |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
