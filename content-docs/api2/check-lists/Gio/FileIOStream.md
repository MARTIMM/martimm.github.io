...
## Gnome::Gio::FileIOStream

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|FileIOStream.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|FileIOStream.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|FileIOStream.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-etag |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| query-info |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| query-info-async |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| query-info-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
