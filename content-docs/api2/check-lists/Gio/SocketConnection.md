...
## Gnome::Gio::SocketConnection

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SocketConnection.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SocketConnection.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SocketConnection.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| connect |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| connect-async |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| connect-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
...
| get-socket |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| is-connected |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| factory-lookup-type |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| factory-register-type |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
