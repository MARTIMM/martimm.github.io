...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|TestDBus.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|TestDBus.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|TestDBus.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gtestdbus |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add-service-dir |![](/content-docs/asset_files/images/checklist-implement.png)|||
| down |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-bus-address |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-flags |![](/content-docs/asset_files/images/checklist-implement.png)|||
| stop |![](/content-docs/asset_files/images/checklist-implement.png)|||
| up |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
2. Version of introduction, otherwise it is the release version (2.34)
