...
## Gnome::Gio::ZlibCompressor

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ZlibCompressor.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ZlibCompressor.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ZlibCompressor.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gzlibcompressor |![](/content-docs/asset_files/images/checklist-implement.png)| 2.24 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-file-info |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| set-file-info |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
