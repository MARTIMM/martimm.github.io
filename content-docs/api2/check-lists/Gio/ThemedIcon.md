...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ThemedIcon.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ThemedIcon.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ThemedIcon.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-from-names |![](/content-docs/asset_files/images/checklist-implement.png)|||
| new-gthemedicon |![](/content-docs/asset_files/images/checklist-implement.png)|||
| new-with-default-fallbacks |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| append-name |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-names |![](/content-docs/asset_files/images/checklist-implement.png)|||
| prepend-name |![](/content-docs/asset_files/images/checklist-implement.png)| 2.18 ||
