...
## Gnome::Gio::Credentials

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Credentials.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Credentials.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Credentials.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gcredentials |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-native |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| get-unix-pid |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 2.36 ||
| get-unix-user |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 2.26 ||
| is-same-user |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| set-native |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| set-unix-user |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 2.26 ||
| to-string |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
