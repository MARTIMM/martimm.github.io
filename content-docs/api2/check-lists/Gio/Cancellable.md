...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Cancellable.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Cancellable.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Cancellable.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gcancellable |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| cancel |![](/content-docs/asset_files/images/checklist-implement.png)|||
| connect |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| disconnect |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| get-fd |![](/content-docs/asset_files/images/checklist-implement.png)|||
| is-cancelled |![](/content-docs/asset_files/images/checklist-implement.png)|||
| make-pollfd |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| pop-current |![](/content-docs/asset_files/images/checklist-implement.png)|||
| push-current |![](/content-docs/asset_files/images/checklist-implement.png)|||
| release-fd |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| reset |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-error-if-cancelled |![](/content-docs/asset_files/images/checklist-implement.png)|||
| source-new |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
