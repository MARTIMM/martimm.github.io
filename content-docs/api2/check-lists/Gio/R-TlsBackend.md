...
## Gnome::Gio::R-TlsBackend

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|R-TlsBackend.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-TlsBackend.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|R-TlsBackend.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-certificate-type |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
| get-client-connection-type |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
| get-default-database |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| get-dtls-client-connection-type |![](/content-docs/asset_files/images/checklist-implement.png)| 2.48 ||
| get-dtls-server-connection-type |![](/content-docs/asset_files/images/checklist-implement.png)| 2.48 ||
| get-file-database-type |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| get-server-connection-type |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
| set-default-database |![](/content-docs/asset_files/images/checklist-implement.png)| 2.60 ||
| supports-dtls |![](/content-docs/asset_files/images/checklist-implement.png)| 2.48 ||
| supports-tls |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-default |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
