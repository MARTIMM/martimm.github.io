...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|BytesIcon.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|BytesIcon.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|BytesIcon.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gbytesicon |![](/content-docs/asset_files/images/checklist-implement.png)| 2.38 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-bytes |![](/content-docs/asset_files/images/checklist-implement.png)| 2.38 ||

<br/>

1. Status, generated, missing values, deprecated, etc
2. Version of introduction, otherwise it is the release version (2.38)
