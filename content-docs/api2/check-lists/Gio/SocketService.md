...
## Gnome::Gio::SocketService

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SocketService.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SocketService.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SocketService.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gsocketservice |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| is-active |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
