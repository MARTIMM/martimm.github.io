...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|MenuLinkIter.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|MenuLinkIter.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|MenuLinkIter.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-name |![](/content-docs/asset_files/images/checklist-ok.png)| 2.32 ||
| get-next |![](/content-docs/asset_files/images/checklist-ok.png)| 2.32 ||
| get-value |![](/content-docs/asset_files/images/checklist-ok.png)| 2.32 ||
| next |![](/content-docs/asset_files/images/checklist-ok.png)| 2.32 ||
