...
## Gnome::Gio::MemoryOutputStream

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|MemoryOutputStream.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|MemoryOutputStream.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|MemoryOutputStream.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gmemoryoutputstream |![](/content-docs/asset_files/images/checklist-implement.png)|||
| new-resizable |![](/content-docs/asset_files/images/checklist-implement.png)| 2.36 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-data |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-data-size |![](/content-docs/asset_files/images/checklist-implement.png)| 2.18 ||
| get-size |![](/content-docs/asset_files/images/checklist-implement.png)|||
| steal-as-bytes |![](/content-docs/asset_files/images/checklist-implement.png)| 2.34 ||
| steal-data |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
