...
## Gnome::Gio::TcpWrapperConnection

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|TcpWrapperConnection.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|TcpWrapperConnection.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|TcpWrapperConnection.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gtcpwrapperconnection |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-base-io-stream |![](/content-docs/asset_files/images/checklist-implement.png)|||
