...
## Gnome::Gio::SimpleProxyResolver

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SimpleProxyResolver.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SimpleProxyResolver.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SimpleProxyResolver.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| set-default-proxy |![](/content-docs/asset_files/images/checklist-implement.png)| 2.36 ||
| set-ignore-hosts |![](/content-docs/asset_files/images/checklist-implement.png)| 2.36 ||
| set-uri-proxy |![](/content-docs/asset_files/images/checklist-implement.png)| 2.36 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new |![](/content-docs/asset_files/images/checklist-implement.png)| 2.36 ||

<br/>

1. Status, generated, missing values, deprecated, etc
2. Version of introduction, otherwise it is the release version (2.36)
