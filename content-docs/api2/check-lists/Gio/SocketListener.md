...
## Gnome::Gio::SocketListener

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SocketListener.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SocketListener.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SocketListener.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gsocketlistener |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
...
| accept-async |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| accept-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| accept-socket |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| accept-socket-async |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| accept-socket-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| add-address |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| add-any-inet-port |![](/content-docs/asset_files/images/checklist-implement.png)| 2.24 ||
| add-inet-port |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| add-socket |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| close |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| set-backlog |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
