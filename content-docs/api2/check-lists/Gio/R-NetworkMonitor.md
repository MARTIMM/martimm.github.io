...
## Gnome::Gio::R-NetworkMonitor

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|R-NetworkMonitor.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-NetworkMonitor.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|R-NetworkMonitor.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| can-reach |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| can-reach-async |![](/content-docs/asset_files/images/checklist-implement.png)|||
| can-reach-finish |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-connectivity |![](/content-docs/asset_files/images/checklist-implement.png)| 2.44 ||
| get-network-available |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| get-network-metered |![](/content-docs/asset_files/images/checklist-implement.png)| 2.46 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-default |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
