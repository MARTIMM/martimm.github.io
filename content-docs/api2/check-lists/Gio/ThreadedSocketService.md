...
## Gnome::Gio::ThreadedSocketService

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ThreadedSocketService.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ThreadedSocketService.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ThreadedSocketService.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gthreadedsocketservice |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
