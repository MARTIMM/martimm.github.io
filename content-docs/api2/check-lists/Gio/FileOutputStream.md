...
## Gnome::Gio::FileOutputStream

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|FileOutputStream.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|FileOutputStream.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|FileOutputStream.rakutest|0 tests|
...
| query-info |![](/content-docs/asset_files/images/checklist-implement.png)|||
| query-info-async |![](/content-docs/asset_files/images/checklist-implement.png)|||
| query-info-finish |![](/content-docs/asset_files/images/checklist-implement.png)|||
