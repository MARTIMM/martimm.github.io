...
## Gnome::Gio::UnixCredentialsMessage

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|UnixCredentialsMessage.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|UnixCredentialsMessage.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|UnixCredentialsMessage.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gunixcredentialsmessage |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| new-with-credentials |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
