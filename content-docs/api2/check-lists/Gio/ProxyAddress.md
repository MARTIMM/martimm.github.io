...
## Gnome::Gio::ProxyAddress

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ProxyAddress.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ProxyAddress.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ProxyAddress.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gproxyaddress |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-destination-hostname |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| get-destination-port |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| get-destination-protocol |![](/content-docs/asset_files/images/checklist-implement.png)| 2.34 ||
| get-password |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| get-protocol |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| get-uri |![](/content-docs/asset_files/images/checklist-implement.png)| 2.34 ||
| get-username |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
