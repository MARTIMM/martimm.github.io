...
## Gnome::Gio::SocketAddressEnumerator

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SocketAddressEnumerator.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SocketAddressEnumerator.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SocketAddressEnumerator.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| next |![](/content-docs/asset_files/images/checklist-implement.png)|||
| next-async |![](/content-docs/asset_files/images/checklist-implement.png)|||
| next-finish |![](/content-docs/asset_files/images/checklist-implement.png)|||
