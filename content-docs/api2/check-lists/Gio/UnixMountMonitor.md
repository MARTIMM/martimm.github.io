...
## Gnome::Gio::UnixMountMonitor

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|UnixMountMonitor.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|UnixMountMonitor.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|UnixMountMonitor.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gunixmountmonitor |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-deprecated.png)||2.44 |
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| set-rate-limit |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-deprecated.png)| 2.18 |2.44 |
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get |![](/content-docs/asset_files/images/checklist-implement.png)| 2.44 ||
