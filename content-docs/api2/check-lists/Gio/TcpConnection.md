...
## Gnome::Gio::TcpConnection

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|TcpConnection.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|TcpConnection.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|TcpConnection.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-graceful-disconnect |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| set-graceful-disconnect |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
