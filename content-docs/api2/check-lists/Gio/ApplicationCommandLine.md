...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|ApplicationCommandLine.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ApplicationCommandLine.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ApplicationCommandLine.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| create-file-for-arg |![](/content-docs/asset_files/images/checklist-ok.png)| 2.36 ||
| done |![](/content-docs/asset_files/images/checklist-ok.png)| 2.80 ||
| get-arguments |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
| get-cwd |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
| get-environ |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
| get-exit-status |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
| get-is-remote |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
| get-options-dict |![](/content-docs/asset_files/images/checklist-ok.png)| 2.40 ||
| get-platform-data |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
| get-stdin |![](/content-docs/asset_files/images/checklist-ok.png)| 2.34 ||
| getenv |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
| print |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
| print-literal |![](/content-docs/asset_files/images/checklist-ok.png)| 2.80 ||
| printerr |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
| printerr-literal |![](/content-docs/asset_files/images/checklist-ok.png)| 2.80 ||
| set-exit-status |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
