...
## Gnome::Gio::SimpleIOStream

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SimpleIOStream.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SimpleIOStream.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SimpleIOStream.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gsimpleiostream |![](/content-docs/asset_files/images/checklist-implement.png)| 2.44 ||

<br/>

1. Status, generated, missing values, deprecated, etc
2. Version of introduction, otherwise it is the release version (2.44)
