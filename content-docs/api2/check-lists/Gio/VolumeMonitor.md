...
## Gnome::Gio::VolumeMonitor

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|VolumeMonitor.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|VolumeMonitor.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|VolumeMonitor.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-connected-drives |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-mount-for-uuid |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-mounts |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-volume-for-uuid |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| adopt-orphan-mount |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-deprecated.png)||2.20 |
