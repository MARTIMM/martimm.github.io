...
## Gnome::Gio::DBusAuthObserver

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|DBusAuthObserver.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|DBusAuthObserver.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|DBusAuthObserver.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gdbusauthobserver |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| allow-mechanism |![](/content-docs/asset_files/images/checklist-implement.png)| 2.34 ||
| authorize-authenticated-peer |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
