...
## Gnome::Gio::R-AsyncInitable

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|R-AsyncInitable.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-AsyncInitable.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|R-AsyncInitable.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| init-async |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| init-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| new-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-async |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| new-valist-async |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 2.22 ||
| newv-async |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-deprecated.png)| 2.22 |2.54 |
