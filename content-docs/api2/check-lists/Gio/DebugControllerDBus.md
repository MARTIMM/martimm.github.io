...
## Gnome::Gio::DebugControllerDBus

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|DebugControllerDBus.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|DebugControllerDBus.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|DebugControllerDBus.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gdebugcontrollerdbus |![](/content-docs/asset_files/images/checklist-implement.png)| 2.72 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| stop |![](/content-docs/asset_files/images/checklist-implement.png)| 2.72 ||

<br/>

1. Status, generated, missing values, deprecated, etc
2. Version of introduction, otherwise it is the release version (2.72)
