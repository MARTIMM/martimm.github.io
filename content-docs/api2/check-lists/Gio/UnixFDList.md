...
## Gnome::Gio::UnixFDList

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|UnixFDList.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|UnixFDList.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|UnixFDList.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-from-array |![](/content-docs/asset_files/images/checklist-implement.png)| 2.24 ||
| new-gunixfdlist |![](/content-docs/asset_files/images/checklist-implement.png)| 2.24 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| append |![](/content-docs/asset_files/images/checklist-implement.png)| 2.24 ||
| get |![](/content-docs/asset_files/images/checklist-implement.png)| 2.24 ||
| get-length |![](/content-docs/asset_files/images/checklist-implement.png)| 2.24 ||
| peek-fds |![](/content-docs/asset_files/images/checklist-implement.png)| 2.24 ||
| steal-fds |![](/content-docs/asset_files/images/checklist-implement.png)| 2.24 ||
