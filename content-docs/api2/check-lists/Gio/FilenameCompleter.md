...
## Gnome::Gio::FilenameCompleter

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|FilenameCompleter.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|FilenameCompleter.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|FilenameCompleter.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gfilenamecompleter |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-completion-suffix |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-completions |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-dirs-only |![](/content-docs/asset_files/images/checklist-implement.png)|||
