...
## Gnome::Gio::ConverterOutputStream

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ConverterOutputStream.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ConverterOutputStream.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ConverterOutputStream.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gconverteroutputstream |![](/content-docs/asset_files/images/checklist-implement.png)|||
