...
## Gnome::Gio::N-FileAttributeMatcher

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-GFileAttributeMatcher.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-GFileAttributeMatcher.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-GFileAttributeMatcher.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gfileattributematcher |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| enumerate-namespace |![](/content-docs/asset_files/images/checklist-implement.png)|||
| enumerate-next |![](/content-docs/asset_files/images/checklist-implement.png)|||
| matches |![](/content-docs/asset_files/images/checklist-implement.png)|||
| matches-only |![](/content-docs/asset_files/images/checklist-implement.png)|||
| ref |![](/content-docs/asset_files/images/checklist-implement.png)|||
| subtract |![](/content-docs/asset_files/images/checklist-implement.png)|||
| to-string |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
