...
## Gnome::Gio::DBusObjectSkeleton

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|DBusObjectSkeleton.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|DBusObjectSkeleton.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|DBusObjectSkeleton.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gdbusobjectskeleton |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add-interface |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| flush |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| remove-interface |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| remove-interface-by-name |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| set-object-path |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
