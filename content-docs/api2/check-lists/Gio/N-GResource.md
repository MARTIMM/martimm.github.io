...
## Gnome::Gio::N-Resource

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-GResource.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-GResource.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-GResource.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-from-data |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| -register |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| -unregister |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| enumerate-children |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| get-info |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| lookup-data |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| open-stream |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| ref |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| unref |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| load |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
