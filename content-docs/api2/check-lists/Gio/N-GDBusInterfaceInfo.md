...
## Gnome::Gio::N-DBusInterfaceInfo

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-GDBusInterfaceInfo.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-GDBusInterfaceInfo.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-GDBusInterfaceInfo.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| cache-build |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| cache-release |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| generate-xml |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| lookup-method |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| lookup-property |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| lookup-signal |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| ref |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| unref |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
