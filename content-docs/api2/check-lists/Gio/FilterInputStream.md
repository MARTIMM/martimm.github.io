...
## Gnome::Gio::FilterInputStream

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|FilterInputStream.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|FilterInputStream.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|FilterInputStream.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-base-stream |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-close-base-stream |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-close-base-stream |![](/content-docs/asset_files/images/checklist-implement.png)|||
