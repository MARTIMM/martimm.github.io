...
## Gnome::Gio::BufferedOutputStream

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|BufferedOutputStream.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|BufferedOutputStream.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|BufferedOutputStream.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gbufferedoutputstream |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-auto-grow |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-buffer-size |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-auto-grow |![](/content-docs/asset_files/images/checklist-implement.png)|||
