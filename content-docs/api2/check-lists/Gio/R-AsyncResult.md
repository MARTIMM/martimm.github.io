...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|R-AsyncResult.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-AsyncResult.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|R-AsyncResult.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-source-object |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-user-data |![](/content-docs/asset_files/images/checklist-ok.png)|||
| is-tagged |![](/content-docs/asset_files/images/checklist-implement.png)| 2.34 ||
| legacy-propagate-error |![](/content-docs/asset_files/images/checklist-implement.png)| 2.34 ||
