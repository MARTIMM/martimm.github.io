...
## Gnome::Gio::ZlibDecompressor

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ZlibDecompressor.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ZlibDecompressor.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ZlibDecompressor.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gzlibdecompressor |![](/content-docs/asset_files/images/checklist-implement.png)| 2.24 ||
