...
## Gnome::Gio::TlsPassword

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|TlsPassword.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|TlsPassword.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|TlsPassword.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gtlspassword |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-description |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| get-flags |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| get-value |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| get-warning |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| set-description |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| set-flags |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| set-value |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| set-value-full |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| set-warning |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
