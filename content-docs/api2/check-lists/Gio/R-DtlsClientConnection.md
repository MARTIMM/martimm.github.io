...
## Gnome::Gio::R-DtlsClientConnection

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|R-DtlsClientConnection.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-DtlsClientConnection.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|R-DtlsClientConnection.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-accepted-cas |![](/content-docs/asset_files/images/checklist-implement.png)| 2.48 ||
| get-server-identity |![](/content-docs/asset_files/images/checklist-implement.png)| 2.48 ||
| get-validation-flags |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-deprecated.png)| 2.48 |2.74 |
| set-server-identity |![](/content-docs/asset_files/images/checklist-implement.png)| 2.48 ||
| set-validation-flags |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-deprecated.png)| 2.48 |2.74 |
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new |![](/content-docs/asset_files/images/checklist-implement.png)| 2.48 ||
