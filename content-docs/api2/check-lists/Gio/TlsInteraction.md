...
## Gnome::Gio::TlsInteraction

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|TlsInteraction.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|TlsInteraction.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|TlsInteraction.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| ask-password |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| ask-password-async |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| ask-password-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| invoke-ask-password |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| invoke-request-certificate |![](/content-docs/asset_files/images/checklist-implement.png)| 2.40 ||
| request-certificate |![](/content-docs/asset_files/images/checklist-implement.png)| 2.40 ||
| request-certificate-async |![](/content-docs/asset_files/images/checklist-implement.png)| 2.40 ||
| request-certificate-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 2.40 ||
