...
## Gnome::Gio::DBusServer

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|DBusServer.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|DBusServer.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|DBusServer.rakutest|0 tests|
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-client-address |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
...
| is-active |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| start |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
| stop |![](/content-docs/asset_files/images/checklist-implement.png)| 2.26 ||
