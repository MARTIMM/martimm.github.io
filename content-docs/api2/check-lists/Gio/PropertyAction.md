...
## Gnome::Gio::PropertyAction

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|PropertyAction.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|PropertyAction.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|PropertyAction.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gpropertyaction |![](/content-docs/asset_files/images/checklist-implement.png)| 2.38 ||
