...
## Gnome::Gio::InetSocketAddress

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|InetSocketAddress.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|InetSocketAddress.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|InetSocketAddress.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-from-string |![](/content-docs/asset_files/images/checklist-implement.png)| 2.40 ||
| new-ginetsocketaddress |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-address |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| get-flowinfo |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| get-port |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| get-scope-id |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
