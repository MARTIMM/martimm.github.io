...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|R-Action.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-Action.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|R-Action.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| activate |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
| change-state |![](/content-docs/asset_files/images/checklist-implement.png)| 2.30 ||
| get-enabled |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
| get-name |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
| get-parameter-type |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
| get-state |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
| get-state-hint |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
| get-state-type |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| name-is-valid |![](/content-docs/asset_files/images/checklist-implement.png)| 2.38 ||
| parse-detailed-name |![](/content-docs/asset_files/images/checklist-implement.png)| 2.38 ||
| print-detailed-name |![](/content-docs/asset_files/images/checklist-implement.png)| 2.38 ||
