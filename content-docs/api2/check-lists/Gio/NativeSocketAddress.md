...
## Gnome::Gio::NativeSocketAddress

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|NativeSocketAddress.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|NativeSocketAddress.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|NativeSocketAddress.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gnativesocketaddress |![](/content-docs/asset_files/images/checklist-implement.png)| 2.46 ||

<br/>

1. Status, generated, missing values, deprecated, etc
2. Version of introduction, otherwise it is the release version (2.46)
