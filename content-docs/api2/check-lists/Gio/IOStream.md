...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|IOStream.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|IOStream.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|IOStream.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| clear-pending |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| close |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| close-async |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| close-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| get-input-stream |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| get-output-stream |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| has-pending |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| is-closed |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| set-pending |![](/content-docs/asset_files/images/checklist-implement.png)| 2.22 ||
| splice-async |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| splice-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 2.28 ||
