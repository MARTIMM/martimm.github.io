...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|SimpleAction.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SimpleAction.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-ok.png)|SimpleAction.rakutest|2 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gsimpleaction |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
| new-stateful |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| set-enabled |![](/content-docs/asset_files/images/checklist-ok.png)| 2.28 ||
| set-state |![](/content-docs/asset_files/images/checklist-ok.png)| 2.30 ||
| set-state-hint |![](/content-docs/asset_files/images/checklist-ok.png)| 2.44 ||
