...
## Gnome::Gio::UnixInputStream

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|UnixInputStream.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|UnixInputStream.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|UnixInputStream.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gunixinputstream |![](/content-docs/asset_files/images/checklist-implement.png)|||
