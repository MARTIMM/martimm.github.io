...
## Gnome::Gio::N-SettingsSchemaSource

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-GSettingsSchemaSource.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-GSettingsSchemaSource.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-GSettingsSchemaSource.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-from-directory |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| list-schemas |![](/content-docs/asset_files/images/checklist-implement.png)| 2.40 ||
| lookup |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
