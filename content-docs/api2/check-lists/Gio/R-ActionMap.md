...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|R-ActionMap.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-ActionMap.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|R-ActionMap.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add-action |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| add-action-entries |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| lookup-action |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| remove-action |![](/content-docs/asset_files/images/checklist-implement.png)| 2.32 ||
| remove-action-entries |![](/content-docs/asset_files/images/checklist-implement.png)| 2.78 ||
