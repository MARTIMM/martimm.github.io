...
## Gnome::Gdk4::N-ToplevelLayout

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-GdkToplevelLayout.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-GdkToplevelLayout.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-GdkToplevelLayout.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-toplevellayout |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| get-fullscreen |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
| get-fullscreen-monitor |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-maximized |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
...
| set-fullscreen |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-maximized |![](/content-docs/asset_files/images/checklist-implement.png)|||
