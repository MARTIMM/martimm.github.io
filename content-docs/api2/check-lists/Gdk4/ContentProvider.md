...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|ContentProvider.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ContentProvider.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ContentProvider.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-for-bytes |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-for-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-typed |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-union |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| content-changed |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| ref-formats |![](/content-docs/asset_files/images/checklist-ok.png)|||
| ref-storable-formats |![](/content-docs/asset_files/images/checklist-ok.png)|||
| write-mime-type-async |![](/content-docs/asset_files/images/checklist-ok.png)|||
| write-mime-type-finish |![](/content-docs/asset_files/images/checklist-ok.png)|||
