...
## Gnome::Gdk4::N-TextureDownloader

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-TextureDownloader.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-TextureDownloader.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-TextureDownloader.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-texturedownloader |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| copy |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| download-bytes |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| download-into |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| free |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| get-color-state |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| get-format |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| get-texture |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| set-color-state |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| set-format |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| set-texture |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
