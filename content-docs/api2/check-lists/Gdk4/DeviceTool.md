...
## Gnome::Gdk4::DeviceTool

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|DeviceTool.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|DeviceTool.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|DeviceTool.rakutest|0 tests|
...
| get-hardware-id |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-serial |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-tool-type |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
