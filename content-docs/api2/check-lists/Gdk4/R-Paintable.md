...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|R-Paintable.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-Paintable.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-ok.png)|R-Paintable.rakutest|1 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| compute-concrete-size |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-current-image |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-flags |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-intrinsic-aspect-ratio |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-intrinsic-height |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-intrinsic-width |![](/content-docs/asset_files/images/checklist-ok.png)|||
| invalidate-contents |![](/content-docs/asset_files/images/checklist-ok.png)|||
| invalidate-size |![](/content-docs/asset_files/images/checklist-ok.png)|||
| snapshot |![](/content-docs/asset_files/images/checklist-ok.png)|||
