...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|Texture.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Texture.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Texture.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-for-pixbuf |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-from-bytes |![](/content-docs/asset_files/images/checklist-implement.png)| 4.6 ||
| new-from-file |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-from-filename |![](/content-docs/asset_files/images/checklist-implement.png)| 4.6 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| download |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| save-to-png |![](/content-docs/asset_files/images/checklist-ok.png)|||
| save-to-png-bytes |![](/content-docs/asset_files/images/checklist-implement.png)| 4.6 ||
| save-to-tiff |![](/content-docs/asset_files/images/checklist-implement.png)| 4.6 ||
| save-to-tiff-bytes |![](/content-docs/asset_files/images/checklist-implement.png)| 4.6 ||
