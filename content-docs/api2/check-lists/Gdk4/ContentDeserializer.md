...
## Gnome::Gdk4::ContentDeserializer

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ContentDeserializer.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ContentDeserializer.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ContentDeserializer.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-cancellable |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-gtype |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| get-priority |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-task-data |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-user-data |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-value |![](/content-docs/asset_files/images/checklist-implement.png)|||
| return-error |![](/content-docs/asset_files/images/checklist-implement.png)|||
| return-success |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-task-data |![](/content-docs/asset_files/images/checklist-implement.png)|||
