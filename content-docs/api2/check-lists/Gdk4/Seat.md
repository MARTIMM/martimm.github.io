...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Seat.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Seat.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Seat.rakutest|0 tests|
...
| get-devices |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
| get-display |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-keyboard |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-pointer |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-tools |![](/content-docs/asset_files/images/checklist-implement.png)|||
