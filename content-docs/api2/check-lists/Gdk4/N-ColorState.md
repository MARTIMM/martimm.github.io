...
## Gnome::Gdk4::N-ColorState

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-ColorState.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-ColorState.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-ColorState.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| create-cicp-params |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| equal |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| ref |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| unref |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-oklab |![](/content-docs/asset_files/images/checklist-implement.png)| 4.18 ||
| get-oklch |![](/content-docs/asset_files/images/checklist-implement.png)| 4.18 ||
| get-rec2100-linear |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| get-rec2100-pq |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| get-srgb |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| get-srgb-linear |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
