...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|KeyEvent.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|KeyEvent.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|KeyEvent.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-consumed-modifiers |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-keycode |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-keyval |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-layout |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-level |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-match |![](/content-docs/asset_files/images/checklist-implement.png)|||
| is-modifier |![](/content-docs/asset_files/images/checklist-implement.png)|||
| matches |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
