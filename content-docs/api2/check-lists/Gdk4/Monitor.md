...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Monitor.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Monitor.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Monitor.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-connector |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-description |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| get-display |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-geometry |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-height-mm |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-manufacturer |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-model |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-refresh-rate |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-scale |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
| get-scale-factor |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-subpixel-layout |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
| get-width-mm |![](/content-docs/asset_files/images/checklist-implement.png)|||
| is-valid |![](/content-docs/asset_files/images/checklist-implement.png)|||
