...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|PadEvent.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|PadEvent.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|PadEvent.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-axis-value |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-button |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-group-mode |![](/content-docs/asset_files/images/checklist-implement.png)|||
