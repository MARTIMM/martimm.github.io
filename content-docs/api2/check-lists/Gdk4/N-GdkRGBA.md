...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|N-GdkRGBA.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-GdkRGBA.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-GdkRGBA.rakutest|0 tests|
...
| is-clear |![](/content-docs/asset_files/images/checklist-ok.png)|||
| is-opaque |![](/content-docs/asset_files/images/checklist-ok.png)|||
| parse |![](/content-docs/asset_files/images/checklist-ok.png)|||
