...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|Drag.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-ok.png)|Drag.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Drag.rakutest|0 tests|

<br/><strong>Note:</strong> Need higher level tests

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| drop-done |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-actions |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-content |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-device |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-display |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-drag-surface |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-formats |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-selected-action |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-surface |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-hotspot |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| begin |![](/content-docs/asset_files/images/checklist-ok.png)|||
