...
## Gnome::Gdk4::GLTexture

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|GLTexture.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|GLTexture.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|GLTexture.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gltexture |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-deprecated.png)||4.12 |
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| release |![](/content-docs/asset_files/images/checklist-implement.png)|||
