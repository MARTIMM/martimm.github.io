...
## Gnome::Gdk4::CicpParams

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|CicpParams.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|CicpParams.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|CicpParams.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-cicpparams |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| build-color-state |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| get-color-primaries |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| get-matrix-coefficients |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| get-range |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 4.16 ||
| get-transfer-function |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| set-color-primaries |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| set-matrix-coefficients |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| set-range |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 4.16 ||
| set-transfer-function |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
