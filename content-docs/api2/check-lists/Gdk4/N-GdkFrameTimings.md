...
## Gnome::Gdk4::N-FrameTimings

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-GdkFrameTimings.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-GdkFrameTimings.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-GdkFrameTimings.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-complete |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| get-predicted-presentation-time |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-presentation-time |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-refresh-interval |![](/content-docs/asset_files/images/checklist-implement.png)|||
