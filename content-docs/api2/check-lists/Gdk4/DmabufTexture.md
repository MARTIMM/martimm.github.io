...
## Gnome::Gdk4::DmabufTexture

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|DmabufTexture.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|DmabufTexture.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|DmabufTexture.rakutest|0 tests|
