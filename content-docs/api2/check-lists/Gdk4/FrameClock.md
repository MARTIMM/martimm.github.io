...
## Gnome::Gdk4::FrameClock

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|FrameClock.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|FrameClock.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|FrameClock.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| begin-updating |![](/content-docs/asset_files/images/checklist-implement.png)|||
| end-updating |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-current-timings |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-fps |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-frame-counter |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-frame-time |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-history-start |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-refresh-info |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
| get-timings |![](/content-docs/asset_files/images/checklist-implement.png)|||
| request-phase |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
