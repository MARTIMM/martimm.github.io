...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Cursor.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Cursor.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Cursor.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-from-callback |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| new-from-name |![](/content-docs/asset_files/images/checklist-implement.png)|||
| new-from-texture |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-fallback |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-hotspot-x |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-hotspot-y |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-name |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-texture |![](/content-docs/asset_files/images/checklist-implement.png)|||
