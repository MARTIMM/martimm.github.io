...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|N-FileList.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-FileList.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-FileList.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-from-array |![](/content-docs/asset_files/images/checklist-implement.png)| 4.8 ||
| new-from-list |![](/content-docs/asset_files/images/checklist-implement.png)| 4.8 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-files |![](/content-docs/asset_files/images/checklist-implement.png)| 4.6 ||
