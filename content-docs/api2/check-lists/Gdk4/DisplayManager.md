...
## Gnome::Gdk4::DisplayManager

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|DisplayManager.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|DisplayManager.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|DisplayManager.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-default-display |![](/content-docs/asset_files/images/checklist-implement.png)|||
| list-displays |![](/content-docs/asset_files/images/checklist-implement.png)|||
| open-display |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-default-display |![](/content-docs/asset_files/images/checklist-implement.png)|||
