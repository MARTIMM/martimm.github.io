...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|N-ContentFormats.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-ContentFormats.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-ContentFormats.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-contentformats |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-for-gtype |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| contain-gtype |![](/content-docs/asset_files/images/checklist-ok.png)|||
| contain-mime-type |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-gtypes |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
| get-mime-types |![](/content-docs/asset_files/images/checklist-ok.png)|||
| is-empty |![](/content-docs/asset_files/images/checklist-implement.png)| 4.18 ||
| match |![](/content-docs/asset_files/images/checklist-ok.png)|||
| match-gtype |![](/content-docs/asset_files/images/checklist-ok.png)|||
| match-mime-type |![](/content-docs/asset_files/images/checklist-ok.png)|||
| print |![](/content-docs/asset_files/images/checklist-ok.png)|||
| ref |![](/content-docs/asset_files/images/checklist-ok.png)|||
| to-string |![](/content-docs/asset_files/images/checklist-ok.png)|||
| union |![](/content-docs/asset_files/images/checklist-ok.png)|||
| union-deserialize-gtypes |![](/content-docs/asset_files/images/checklist-ok.png)|||
| union-deserialize-mime-types |![](/content-docs/asset_files/images/checklist-ok.png)|||
| union-serialize-gtypes |![](/content-docs/asset_files/images/checklist-ok.png)|||
| union-serialize-mime-types |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| parse |![](/content-docs/asset_files/images/checklist-implement.png)| 4.4 ||
