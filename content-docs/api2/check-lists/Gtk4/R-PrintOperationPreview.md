...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|R-PrintOperationPreview.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-PrintOperationPreview.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|R-PrintOperationPreview.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| end-preview |![](/content-docs/asset_files/images/checklist-ok.png)|||
| is-selected |![](/content-docs/asset_files/images/checklist-ok.png)|||
| render-page |![](/content-docs/asset_files/images/checklist-ok.png)|||
