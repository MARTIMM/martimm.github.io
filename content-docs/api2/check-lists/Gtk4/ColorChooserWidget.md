...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ColorChooserWidget.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ColorChooserWidget.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ColorChooserWidget.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-colorchooserwidget |![](/content-docs/asset_files/images/checklist-ok.png)|||
