...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Viewport.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Viewport.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Viewport.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-viewport |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-scroll-to-focus |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-scroll-to-focus |![](/content-docs/asset_files/images/checklist-ok.png)|||
