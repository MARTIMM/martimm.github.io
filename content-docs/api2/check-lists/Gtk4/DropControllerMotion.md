...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|DropControllerMotion.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|DropControllerMotion.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|DropControllerMotion.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-dropcontrollermotion |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| contains-pointer |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-drop |![](/content-docs/asset_files/images/checklist-ok.png)|||
| is-pointer |![](/content-docs/asset_files/images/checklist-ok.png)|||
