...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Box.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Box.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Box.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-box |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-baseline-child |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
...
| get-spacing |![](/content-docs/asset_files/images/checklist-ok.png)|||
| insert-child-after |![](/content-docs/asset_files/images/checklist-ok.png)|||
| prepend |![](/content-docs/asset_files/images/checklist-ok.png)|||
| remove |![](/content-docs/asset_files/images/checklist-ok.png)|||
| reorder-child-after |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-baseline-child |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
...
| set-spacing |![](/content-docs/asset_files/images/checklist-ok.png)|||
