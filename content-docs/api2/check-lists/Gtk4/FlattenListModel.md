...
## Gnome::Gtk4::FlattenListModel

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|FlattenListModel.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|FlattenListModel.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|FlattenListModel.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-flattenlistmodel |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| get-model-for-item |![](/content-docs/asset_files/images/checklist-implement.png)|||
