...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|TreeListModel.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|TreeListModel.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|TreeListModel.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-treelistmodel |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-autoexpand |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-child-row |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-model |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-passthrough |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-row |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-autoexpand |![](/content-docs/asset_files/images/checklist-ok.png)|||
