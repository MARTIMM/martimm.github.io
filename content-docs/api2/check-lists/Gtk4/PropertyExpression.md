...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|PropertyExpression.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|PropertyExpression.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|PropertyExpression.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-for-pspec |![](/content-docs/asset_files/images/checklist-implement.png)|||
| new-propertyexpression |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| get-pspec |![](/content-docs/asset_files/images/checklist-implement.png)|||
