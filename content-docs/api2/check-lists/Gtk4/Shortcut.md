...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Shortcut.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Shortcut.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Shortcut.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-shortcut |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-with-arguments |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-action |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-arguments |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-trigger |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-action |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-arguments |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-trigger |![](/content-docs/asset_files/images/checklist-ok.png)|||
