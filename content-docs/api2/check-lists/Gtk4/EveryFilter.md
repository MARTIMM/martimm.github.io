...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|EveryFilter.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|EveryFilter.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|EveryFilter.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-everyfilter |![](/content-docs/asset_files/images/checklist-ok.png)|||
