...
## Gnome::Gtk4::WindowGroup

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|WindowGroup.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|WindowGroup.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|WindowGroup.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-windowgroup |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add-window |![](/content-docs/asset_files/images/checklist-implement.png)|||
| list-windows |![](/content-docs/asset_files/images/checklist-implement.png)|||
| remove-window |![](/content-docs/asset_files/images/checklist-implement.png)|||
