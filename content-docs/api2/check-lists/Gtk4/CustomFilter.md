...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|CustomFilter.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|CustomFilter.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|CustomFilter.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-customfilter |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| set-filter-func |![](/content-docs/asset_files/images/checklist-implement.png)|||
