...
## Gnome::Gtk4::PopoverMenu

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|PopoverMenu.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|PopoverMenu.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|PopoverMenu.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-from-model |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-from-model-full |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-flags |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
| get-menu-model |![](/content-docs/asset_files/images/checklist-ok.png)|||
| remove-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-flags |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
