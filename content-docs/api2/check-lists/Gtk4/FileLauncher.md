...
## Gnome::Gtk4::FileLauncher

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|FileLauncher.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|FileLauncher.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|FileLauncher.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-filelauncher |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-always-ask |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
| get-file |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| get-writable |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
| launch |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| launch-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| open-containing-folder |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| open-containing-folder-finish |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| set-always-ask |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
| set-file |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| set-writable |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
