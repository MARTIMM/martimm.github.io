...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|MnemonicTrigger.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|MnemonicTrigger.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|MnemonicTrigger.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-mnemonictrigger |![](/content-docs/asset_files/images/checklist-ok.png)|||
