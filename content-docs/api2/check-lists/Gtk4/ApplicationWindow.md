...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ApplicationWindow.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ApplicationWindow.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ApplicationWindow.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-applicationwindow |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-help-overlay |![](/content-docs/asset_files/images/checklist-ok.png)![](/content-docs/asset_files/images/checklist-deprecated.png)||4.18 |
| get-id |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-show-menubar |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-help-overlay |![](/content-docs/asset_files/images/checklist-ok.png)![](/content-docs/asset_files/images/checklist-deprecated.png)||4.18 |
| set-show-menubar |![](/content-docs/asset_files/images/checklist-ok.png)|||
