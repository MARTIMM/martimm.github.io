...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|GestureLongPress.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|GestureLongPress.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|GestureLongPress.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gesturelongpress |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-delay-factor |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-delay-factor |![](/content-docs/asset_files/images/checklist-ok.png)|||
