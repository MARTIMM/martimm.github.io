...
## Gnome::Gtk4::EventControllerFocus

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|EventControllerFocus.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|EventControllerFocus.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|EventControllerFocus.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-eventcontrollerfocus |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| contains-focus |![](/content-docs/asset_files/images/checklist-implement.png)|||
| is-focus |![](/content-docs/asset_files/images/checklist-implement.png)|||
