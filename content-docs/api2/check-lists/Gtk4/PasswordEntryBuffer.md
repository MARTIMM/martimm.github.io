...
## Gnome::Gtk4::PasswordEntryBuffer

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|PasswordEntryBuffer.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|PasswordEntryBuffer.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|PasswordEntryBuffer.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-passwordentrybuffer |![](/content-docs/asset_files/images/checklist-implement.png)|||
