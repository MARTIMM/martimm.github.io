...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|GestureStylus.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|GestureStylus.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|GestureStylus.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gesturestylus |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-axes |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-axis |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-backlog |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-device-tool |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-stylus-only |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| set-stylus-only |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
