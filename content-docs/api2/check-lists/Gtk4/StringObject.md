...
||State|Name|Tests|
|-|-|-|-|
|Class name||Gnome::Gtk4::StringObject||
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|StringObject.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|StringObject.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|StringObject.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-stringobject |![](/content-docs/asset_files/images/checklist-ok.png)|||
