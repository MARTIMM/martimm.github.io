...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|OverlayLayoutChild.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|OverlayLayoutChild.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|OverlayLayoutChild.rakutest|0 tests|
...
| get-measure |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-clip-overlay |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-measure |![](/content-docs/asset_files/images/checklist-ok.png)|||
