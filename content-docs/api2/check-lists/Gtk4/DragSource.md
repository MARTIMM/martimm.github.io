...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|DragSource.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|DragSource.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|DragSource.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-dragsource |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| drag-cancel |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-actions |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-content |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-drag |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-actions |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-content |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-icon |![](/content-docs/asset_files/images/checklist-ok.png)|||
