...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|HeaderBar.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|HeaderBar.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|HeaderBar.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-headerbar |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-decoration-layout |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-show-title-buttons |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-title-widget |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-use-native-controls |![](/content-docs/asset_files/images/checklist-implement.png)| 4.18 ||
| pack-end |![](/content-docs/asset_files/images/checklist-ok.png)|||
| pack-start |![](/content-docs/asset_files/images/checklist-ok.png)|||
| remove |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-decoration-layout |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-show-title-buttons |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-title-widget |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-use-native-controls |![](/content-docs/asset_files/images/checklist-implement.png)| 4.18 ||
