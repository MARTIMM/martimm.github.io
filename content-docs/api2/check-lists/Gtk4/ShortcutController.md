...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ShortcutController.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ShortcutController.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ShortcutController.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-for-model |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-shortcutcontroller |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add-shortcut |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-mnemonics-modifiers |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-scope |![](/content-docs/asset_files/images/checklist-ok.png)|||
| remove-shortcut |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-mnemonics-modifiers |![](/content-docs/asset_files/images/checklist-ok.png)|||
