...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|NumericSorter.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|NumericSorter.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|NumericSorter.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-numericsorter |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-sort-order |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-expression |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-sort-order |![](/content-docs/asset_files/images/checklist-ok.png)|||
