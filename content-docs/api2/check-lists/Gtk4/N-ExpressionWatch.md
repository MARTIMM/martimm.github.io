...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-ExpressionWatch.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-ExpressionWatch.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-ExpressionWatch.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| evaluate |![](/content-docs/asset_files/images/checklist-implement.png)|||
| ref |![](/content-docs/asset_files/images/checklist-implement.png)|||
| unref |![](/content-docs/asset_files/images/checklist-implement.png)|||
| unwatch |![](/content-docs/asset_files/images/checklist-implement.png)|||
