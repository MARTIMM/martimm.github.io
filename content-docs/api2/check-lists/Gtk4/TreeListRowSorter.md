...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|TreeListRowSorter.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|TreeListRowSorter.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|TreeListRowSorter.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-treelistrowsorter |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-sorter |![](/content-docs/asset_files/images/checklist-ok.png)|||
