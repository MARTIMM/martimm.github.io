...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|GesturePan.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|GesturePan.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|GesturePan.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gesturepan |![](/content-docs/asset_files/images/checklist-ok.png)|||
