...
## Gnome::Gtk4::MediaFile

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|MediaFile.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|MediaFile.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|MediaFile.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-for-file |![](/content-docs/asset_files/images/checklist-implement.png)|||
| new-for-filename |![](/content-docs/asset_files/images/checklist-implement.png)|||
| new-for-input-stream |![](/content-docs/asset_files/images/checklist-implement.png)|||
| new-for-resource |![](/content-docs/asset_files/images/checklist-implement.png)|||
| new-mediafile |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| clear |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-file |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-input-stream |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-file |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-filename |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-input-stream |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-resource |![](/content-docs/asset_files/images/checklist-implement.png)|||
