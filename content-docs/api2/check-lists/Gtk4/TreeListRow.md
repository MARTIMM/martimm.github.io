...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|TreeListRow.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|TreeListRow.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|TreeListRow.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-child-row |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-children |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-depth |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| is-expandable |![](/content-docs/asset_files/images/checklist-ok.png)|||
