...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|GestureSingle.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|GestureSingle.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|GestureSingle.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-button |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-current-button |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-current-sequence |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-exclusive |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-touch-only |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-button |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-exclusive |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-touch-only |![](/content-docs/asset_files/images/checklist-ok.png)|||
