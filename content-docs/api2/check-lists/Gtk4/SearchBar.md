...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SearchBar.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SearchBar.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SearchBar.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-searchbar |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| connect-entry |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-search-mode |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-show-close-button |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-search-mode |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-show-close-button |![](/content-docs/asset_files/images/checklist-ok.png)|||
