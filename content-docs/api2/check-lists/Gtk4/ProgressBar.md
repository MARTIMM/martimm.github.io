...
## Gnome::Gtk4::ProgressBar

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ProgressBar.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ProgressBar.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ProgressBar.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-progressbar |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-fraction |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-inverted |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-pulse-step |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-show-text |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-text |![](/content-docs/asset_files/images/checklist-ok.png)|||
| pulse |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-ellipsize |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-fraction |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-inverted |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-pulse-step |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-show-text |![](/content-docs/asset_files/images/checklist-ok.png)|||
