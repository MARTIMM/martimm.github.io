...
## Gnome::Gtk4::PadController

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|PadController.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|PadController.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|PadController.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-padcontroller |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| set-action |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
| set-action-entries |![](/content-docs/asset_files/images/checklist-implement.png)|||
