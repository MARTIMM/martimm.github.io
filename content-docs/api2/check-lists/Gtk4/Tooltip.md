...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Tooltip.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Tooltip.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Tooltip.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| set-custom |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-tip-area |![](/content-docs/asset_files/images/checklist-ok.png)|||
