...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|N-AccessibleList.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-AccessibleList.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-AccessibleList.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-from-array |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
| new-from-list |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-objects |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
