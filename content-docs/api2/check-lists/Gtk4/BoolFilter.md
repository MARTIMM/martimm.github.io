...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|BoolFilter.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|BoolFilter.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|BoolFilter.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-boolfilter |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-invert |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-expression |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-invert |![](/content-docs/asset_files/images/checklist-ok.png)|||
