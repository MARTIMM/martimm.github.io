...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|AspectFrame.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|AspectFrame.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|AspectFrame.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-aspectframe |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-obey-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-ratio |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-obey-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-ratio |![](/content-docs/asset_files/images/checklist-ok.png)|||
