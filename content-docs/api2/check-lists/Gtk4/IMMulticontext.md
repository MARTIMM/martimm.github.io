...
## Gnome::Gtk4::IMMulticontext

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|IMMulticontext.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|IMMulticontext.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|IMMulticontext.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-immulticontext |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-context-id |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-context-id |![](/content-docs/asset_files/images/checklist-implement.png)|||
