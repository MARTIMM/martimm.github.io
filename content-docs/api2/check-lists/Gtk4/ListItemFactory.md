...
## Gnome::Gtk4::ListItemFactory

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ListItemFactory.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ListItemFactory.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ListItemFactory.rakutest|0 tests|
