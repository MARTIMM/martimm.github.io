...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SpinButton.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SpinButton.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SpinButton.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-spinbutton |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-with-range |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| configure |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-activates-default |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
| get-adjustment |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-climb-rate |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-digits |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-increments |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-numeric |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-range |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-snap-to-ticks |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-update-policy |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-value-as-int |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-wrap |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-activates-default |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
| set-adjustment |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-climb-rate |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-digits |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-increments |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-numeric |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-range |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-snap-to-ticks |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-update-policy |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-wrap |![](/content-docs/asset_files/images/checklist-ok.png)|||
| spin |![](/content-docs/asset_files/images/checklist-ok.png)|||
| update |![](/content-docs/asset_files/images/checklist-ok.png)|||
