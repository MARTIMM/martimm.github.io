...
## Gnome::Gtk4::CheckButton

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|CheckButton.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|CheckButton.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|CheckButton.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-checkbutton |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-with-label |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-active |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-child |![](/content-docs/asset_files/images/checklist-implement.png)| 4.8 ||
| get-inconsistent |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-active |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-child |![](/content-docs/asset_files/images/checklist-implement.png)| 4.8 ||
| set-group |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-inconsistent |![](/content-docs/asset_files/images/checklist-ok.png)|||
