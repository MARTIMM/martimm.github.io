...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SingleSelection.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SingleSelection.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SingleSelection.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-singleselection |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-autoselect |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-can-unselect |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-autoselect |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-can-unselect |![](/content-docs/asset_files/images/checklist-ok.png)|||
