...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|EntryBuffer.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|EntryBuffer.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|EntryBuffer.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-entrybuffer |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| emit-deleted-text |![](/content-docs/asset_files/images/checklist-ok.png)|||
| emit-inserted-text |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-bytes |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-length |![](/content-docs/asset_files/images/checklist-ok.png)|||
