...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|WindowControls.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|WindowControls.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|WindowControls.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-windowcontrols |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-empty |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-side |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-side |![](/content-docs/asset_files/images/checklist-ok.png)|||
