...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SignalListItemFactory.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SignalListItemFactory.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SignalListItemFactory.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-signallistitemfactory |![](/content-docs/asset_files/images/checklist-ok.png)|||
