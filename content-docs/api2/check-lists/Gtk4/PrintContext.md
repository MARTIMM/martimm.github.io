...
## Gnome::Gtk4::PrintContext

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|PrintContext.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|PrintContext.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|PrintContext.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| create-pango-context |![](/content-docs/asset_files/images/checklist-implement.png)|||
| create-pango-layout |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-cairo-context |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-dpi-x |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-dpi-y |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| get-page-setup |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-pango-fontmap |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-width |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-cairo-context |![](/content-docs/asset_files/images/checklist-implement.png)|||
