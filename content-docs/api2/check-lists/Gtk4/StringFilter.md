...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|StringFilter.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|StringFilter.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|StringFilter.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-stringfilter |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-expression |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-ignore-case |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-match-mode |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-search |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-expression |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-ignore-case |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-match-mode |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-search |![](/content-docs/asset_files/images/checklist-implement.png)|||
