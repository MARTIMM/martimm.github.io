...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|N-CssSection.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-CssSection.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-CssSection.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-csssection |![](/content-docs/asset_files/images/checklist-implement.png)|||
| new-with-bytes |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
...
| get-end-location |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-file |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-parent |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-start-location |![](/content-docs/asset_files/images/checklist-implement.png)|||
| print |![](/content-docs/asset_files/images/checklist-implement.png)|||
| ref |![](/content-docs/asset_files/images/checklist-implement.png)|||
| to-string |![](/content-docs/asset_files/images/checklist-implement.png)|||
