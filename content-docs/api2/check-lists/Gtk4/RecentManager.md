...
## Gnome::Gtk4::RecentManager

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|RecentManager.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|RecentManager.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|RecentManager.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-recentmanager |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add-full |![](/content-docs/asset_files/images/checklist-implement.png)|||
| add-item |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-items |![](/content-docs/asset_files/images/checklist-implement.png)|||
| has-item |![](/content-docs/asset_files/images/checklist-implement.png)|||
| lookup-item |![](/content-docs/asset_files/images/checklist-implement.png)|||
| move-item |![](/content-docs/asset_files/images/checklist-implement.png)|||
| purge-items |![](/content-docs/asset_files/images/checklist-implement.png)|||
| remove-item |![](/content-docs/asset_files/images/checklist-implement.png)|||
