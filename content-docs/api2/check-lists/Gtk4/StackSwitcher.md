...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|StackSwitcher.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|StackSwitcher.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|StackSwitcher.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-stackswitcher |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-stack |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-stack |![](/content-docs/asset_files/images/checklist-ok.png)|||
