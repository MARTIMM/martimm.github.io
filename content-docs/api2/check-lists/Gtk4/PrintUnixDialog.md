...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|PrintUnixDialog.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|PrintUnixDialog.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|PrintUnixDialog.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-printunixdialog |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add-custom-tab |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-manual-capabilities |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
| get-page-setup |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-page-setup-set |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-selected-printer |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-manual-capabilities |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)|||
| set-page-setup |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-settings |![](/content-docs/asset_files/images/checklist-ok.png)|||
