...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|GestureDrag.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|GestureDrag.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|GestureDrag.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gesturedrag |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-start-point |![](/content-docs/asset_files/images/checklist-ok.png)|||
