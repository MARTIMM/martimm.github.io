...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Adjustment.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-ok.png)|Adjustment.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Adjustment.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-adjustment |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| clamp-page |![](/content-docs/asset_files/images/checklist-ok.png)|||
| configure |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-lower |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-minimum-increment |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-page-increment |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-page-size |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-step-increment |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-upper |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-lower |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-page-increment |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-page-size |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-step-increment |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-upper |![](/content-docs/asset_files/images/checklist-ok.png)|||
