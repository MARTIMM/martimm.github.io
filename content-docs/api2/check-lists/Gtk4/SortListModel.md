...
## Gnome::Gtk4::SortListModel

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SortListModel.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SortListModel.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SortListModel.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-sortlistmodel |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-incremental |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-model |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-pending |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-section-sorter |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
| get-sorter |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-incremental |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-model |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-section-sorter |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
