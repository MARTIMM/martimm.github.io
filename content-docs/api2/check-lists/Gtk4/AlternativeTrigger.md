...
||State|Name|Tests|
|-|-|-|-|
|Class name||Gnome::Gtk4::AlternativeTrigger||
...
|-------|-|----------|-------|
| new-alternativetrigger |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State|Version|Deprecated|
|-------|-|----------|-------|
| get-first |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-second |![](/content-docs/asset_files/images/checklist-ok.png)|||
