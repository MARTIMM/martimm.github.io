...
## Gnome::Gtk4::ColorDialogButton

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ColorDialogButton.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ColorDialogButton.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ColorDialogButton.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-colordialogbutton |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
...
| get-rgba |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| set-dialog |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| set-rgba |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
