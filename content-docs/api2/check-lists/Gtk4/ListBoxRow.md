...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ListBoxRow.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ListBoxRow.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ListBoxRow.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-listboxrow |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| changed |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-header |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-index |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-header |![](/content-docs/asset_files/images/checklist-ok.png)|||
