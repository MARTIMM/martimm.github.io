...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ListView.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ListView.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ListView.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-listview |![](/content-docs/asset_files/images/checklist-ok.png)|||
