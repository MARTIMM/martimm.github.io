...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|N-ScrollInfo.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|N-ScrollInfo.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|N-ScrollInfo.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-scrollinfo |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-enable-horizontal |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
| get-enable-vertical |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
| ref |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
| set-enable-horizontal |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
| set-enable-vertical |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
| unref |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
