...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|StringSorter.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|StringSorter.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|StringSorter.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-stringsorter |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-collation |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 4.10 ||
| get-expression |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-ignore-case |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-collation |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 4.10 ||
| set-expression |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-ignore-case |![](/content-docs/asset_files/images/checklist-ok.png)|||
