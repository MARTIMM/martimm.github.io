...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Expander.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Expander.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Expander.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-expander |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-expanded |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-label |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-label-widget |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-resize-toplevel |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-expanded |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-label |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-label-widget |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-resize-toplevel |![](/content-docs/asset_files/images/checklist-ok.png)|||
