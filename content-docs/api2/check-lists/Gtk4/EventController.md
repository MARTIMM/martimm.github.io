...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|EventController.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|EventController.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|EventController.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-current-event |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-current-event-device |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-current-event-state |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-current-event-time |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-name |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-propagation-limit |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-propagation-phase |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-widget |![](/content-docs/asset_files/images/checklist-ok.png)|||
| reset |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-name |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-propagation-limit |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-propagation-phase |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-static-name |![](/content-docs/asset_files/images/checklist-implement.png)| 4.8 ||
