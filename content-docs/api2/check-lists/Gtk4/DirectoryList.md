...
## Gnome::Gtk4::DirectoryList

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|DirectoryList.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|DirectoryList.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|DirectoryList.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-directorylist |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-attributes |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| get-io-priority |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-monitored |![](/content-docs/asset_files/images/checklist-implement.png)|||
| is-loading |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-attributes |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-file |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-io-priority |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-monitored |![](/content-docs/asset_files/images/checklist-implement.png)|||
