...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Overlay.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Overlay.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Overlay.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-overlay |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-clip-overlay |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-measure-overlay |![](/content-docs/asset_files/images/checklist-ok.png)|||
| remove-overlay |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-clip-overlay |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-measure-overlay |![](/content-docs/asset_files/images/checklist-ok.png)|||
