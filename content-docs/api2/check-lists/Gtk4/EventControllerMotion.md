...
## Gnome::Gtk4::EventControllerMotion

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|EventControllerMotion.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|EventControllerMotion.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|EventControllerMotion.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-eventcontrollermotion |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| contains-pointer |![](/content-docs/asset_files/images/checklist-implement.png)|||
| is-pointer |![](/content-docs/asset_files/images/checklist-implement.png)|||
