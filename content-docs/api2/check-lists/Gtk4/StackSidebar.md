...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|StackSidebar.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|StackSidebar.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|StackSidebar.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-stacksidebar |![](/content-docs/asset_files/images/checklist-ok.png)|||
