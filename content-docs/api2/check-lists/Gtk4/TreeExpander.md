...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|TreeExpander.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|TreeExpander.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|TreeExpander.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-treeexpander |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-hide-expander |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| get-indent-for-depth |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| get-indent-for-icon |![](/content-docs/asset_files/images/checklist-implement.png)| 4.6 ||
| get-item |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-list-row |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-hide-expander |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| set-indent-for-depth |![](/content-docs/asset_files/images/checklist-implement.png)| 4.10 ||
| set-indent-for-icon |![](/content-docs/asset_files/images/checklist-implement.png)| 4.6 ||
| set-list-row |![](/content-docs/asset_files/images/checklist-ok.png)|||
