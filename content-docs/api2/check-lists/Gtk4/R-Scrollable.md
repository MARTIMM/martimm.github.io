...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|R-Scrollable.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-Scrollable.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|R-Scrollable.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-border |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-hadjustment |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-hscroll-policy |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-vadjustment |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-vscroll-policy |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-hadjustment |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-hscroll-policy |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-vadjustment |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-vscroll-policy |![](/content-docs/asset_files/images/checklist-ok.png)|||
