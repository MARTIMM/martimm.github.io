...
## Gnome::Gtk4::R-Actionable

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|R-Actionable.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|R-Actionable.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|R-Actionable.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-action-name |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-action-target-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-action-name |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-action-target |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-action-target-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-detailed-action-name |![](/content-docs/asset_files/images/checklist-ok.png)|||
