...
## Gnome::Gtk4::NativeDialog

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|NativeDialog.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|NativeDialog.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|NativeDialog.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| destroy |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-modal |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-title |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-transient-for |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-visible |![](/content-docs/asset_files/images/checklist-implement.png)|||
| hide |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| show |![](/content-docs/asset_files/images/checklist-implement.png)|||
