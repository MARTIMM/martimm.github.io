...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ConstraintLayout.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ConstraintLayout.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ConstraintLayout.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-constraintlayout |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add-constraint |![](/content-docs/asset_files/images/checklist-ok.png)|||
| add-constraints-from-description |![](/content-docs/asset_files/images/checklist-ok.png)|||
| add-constraints-from-descriptionv |![](/content-docs/asset_files/images/checklist-ok.png)|||
| add-guide |![](/content-docs/asset_files/images/checklist-ok.png)|||
| observe-constraints |![](/content-docs/asset_files/images/checklist-ok.png)|||
| observe-guides |![](/content-docs/asset_files/images/checklist-ok.png)|||
| remove-all-constraints |![](/content-docs/asset_files/images/checklist-ok.png)|||
| remove-constraint |![](/content-docs/asset_files/images/checklist-ok.png)|||
| remove-guide |![](/content-docs/asset_files/images/checklist-ok.png)|||
