...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|LevelBar.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|LevelBar.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|LevelBar.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-for-interval |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-levelbar |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add-offset-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-inverted |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-max-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-min-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-mode |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-offset-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| remove-offset-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-inverted |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-max-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-min-value |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-mode |![](/content-docs/asset_files/images/checklist-ok.png)|||
