...
## Gnome::Gtk4::GraphicsOffload

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|GraphicsOffload.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|GraphicsOffload.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|GraphicsOffload.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-graphicsoffload |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-black-background |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| get-child |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
| get-enabled |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 4.14 ||
| set-black-background |![](/content-docs/asset_files/images/checklist-implement.png)| 4.16 ||
| set-child |![](/content-docs/asset_files/images/checklist-implement.png)| 4.14 ||
| set-enabled |![](/content-docs/asset_files/images/checklist-implement.png)![](/content-docs/asset_files/images/checklist-missing.png)| 4.14 ||
