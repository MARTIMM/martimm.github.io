...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|BuilderListItemFactory.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|BuilderListItemFactory.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|BuilderListItemFactory.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-from-bytes |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-resource |![](/content-docs/asset_files/images/checklist-ok.png)|||
