...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Spinner.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Spinner.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Spinner.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-spinner |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-spinning |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-spinning |![](/content-docs/asset_files/images/checklist-ok.png)|||
| start |![](/content-docs/asset_files/images/checklist-ok.png)|||
| stop |![](/content-docs/asset_files/images/checklist-ok.png)|||
