...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|GridLayoutChild.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|GridLayoutChild.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|GridLayoutChild.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-column |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-column-span |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-row |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-row-span |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-column |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-column-span |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-row |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-row-span |![](/content-docs/asset_files/images/checklist-ok.png)|||
