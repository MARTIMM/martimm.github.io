...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|FileFilter.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|FileFilter.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|FileFilter.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-filefilter |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-from-gvariant |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add-mime-type |![](/content-docs/asset_files/images/checklist-ok.png)|||
| add-pattern |![](/content-docs/asset_files/images/checklist-ok.png)|||
| add-pixbuf-formats |![](/content-docs/asset_files/images/checklist-ok.png)|||
| add-suffix |![](/content-docs/asset_files/images/checklist-implement.png)| 4.4 ||
...
| to-gvariant |![](/content-docs/asset_files/images/checklist-ok.png)|||
