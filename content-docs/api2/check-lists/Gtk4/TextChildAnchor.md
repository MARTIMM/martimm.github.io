...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|TextChildAnchor.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|TextChildAnchor.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|TextChildAnchor.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-textchildanchor |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-with-replacement |![](/content-docs/asset_files/images/checklist-implement.png)| 4.6 ||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-deleted |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-widgets |![](/content-docs/asset_files/images/checklist-ok.png)|||
