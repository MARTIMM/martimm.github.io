...
## Gnome::Gtk4::EventControllerLegacy

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|EventControllerLegacy.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|EventControllerLegacy.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|EventControllerLegacy.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-eventcontrollerlegacy |![](/content-docs/asset_files/images/checklist-implement.png)|||
