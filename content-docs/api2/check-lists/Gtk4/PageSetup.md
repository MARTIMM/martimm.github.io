...
## Gnome::Gtk4::PageSetup

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|PageSetup.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|PageSetup.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|PageSetup.rakutest|0 tests|
...
| new-pagesetup |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| get-bottom-margin |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-left-margin |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-orientation |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-page-height |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-page-width |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| get-right-margin |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-top-margin |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| set-bottom-margin |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-left-margin |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| set-paper-size-and-default-margins |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-right-margin |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-top-margin |![](/content-docs/asset_files/images/checklist-implement.png)|||
