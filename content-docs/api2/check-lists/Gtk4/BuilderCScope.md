...
## Gnome::Gtk4::BuilderCScope

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|BuilderCScope.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|BuilderCScope.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|BuilderCScope.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-buildercscope |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add-callback-symbol |![](/content-docs/asset_files/images/checklist-implement.png)|||
| add-callback-symbols |![](/content-docs/asset_files/images/checklist-implement.png)|||
| lookup-callback-symbol |![](/content-docs/asset_files/images/checklist-implement.png)|||
