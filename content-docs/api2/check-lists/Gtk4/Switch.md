...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Switch.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Switch.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Switch.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-switch |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-state |![](/content-docs/asset_files/images/checklist-ok.png)|||
