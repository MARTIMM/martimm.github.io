...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|CenterLayout.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|CenterLayout.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|CenterLayout.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-centerlayout |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-baseline-position |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-center-widget |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-end-widget |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-orientation |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-shrink-center-last |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
| get-start-widget |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-baseline-position |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-center-widget |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-end-widget |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-orientation |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-shrink-center-last |![](/content-docs/asset_files/images/checklist-implement.png)| 4.12 ||
| set-start-widget |![](/content-docs/asset_files/images/checklist-ok.png)|||
