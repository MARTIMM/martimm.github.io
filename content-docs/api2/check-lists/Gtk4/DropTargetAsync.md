...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|DropTargetAsync.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|DropTargetAsync.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|DropTargetAsync.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-droptargetasync |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| reject-drop |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-actions |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-formats |![](/content-docs/asset_files/images/checklist-ok.png)|||
