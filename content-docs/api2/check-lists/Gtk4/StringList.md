...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-ok.png)|StringList.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-ok.png)|StringList.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-ok.png)|StringList.rakutest|13 tests|

<br/><strong>Note:</strong> Tests are also done for StringObject and Gio R-ListModel

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-stringlist |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| find |![](/content-docs/asset_files/images/checklist-ok.png)| 4.18 ||
| get-string |![](/content-docs/asset_files/images/checklist-ok.png)|||
| remove |![](/content-docs/asset_files/images/checklist-ok.png)|||
| splice |![](/content-docs/asset_files/images/checklist-ok.png)|||
| take |![](/content-docs/asset_files/images/checklist-no-implement.png)|||

<br/>method **take**: Not needed, use get-string() instead.
