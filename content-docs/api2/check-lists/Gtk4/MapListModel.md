...
## Gnome::Gtk4::MapListModel

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|MapListModel.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|MapListModel.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|MapListModel.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-maplistmodel |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
| has-map |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-map-func |![](/content-docs/asset_files/images/checklist-implement.png)|||
