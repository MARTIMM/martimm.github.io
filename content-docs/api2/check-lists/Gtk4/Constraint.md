...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Constraint.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Constraint.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Constraint.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-constant |![](/content-docs/asset_files/images/checklist-ok.png)|||
| new-constraint |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-constant |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-multiplier |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-relation |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-source |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-source-attribute |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-strength |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-target |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-target-attribute |![](/content-docs/asset_files/images/checklist-ok.png)|||
| is-attached |![](/content-docs/asset_files/images/checklist-ok.png)|||
| is-constant |![](/content-docs/asset_files/images/checklist-ok.png)|||
| is-required |![](/content-docs/asset_files/images/checklist-ok.png)|||
