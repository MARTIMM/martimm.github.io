...
## Gnome::Gtk4::ConstraintGuide

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|ConstraintGuide.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|ConstraintGuide.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|ConstraintGuide.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-constraintguide |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-max-size |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-min-size |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-name |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-nat-size |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-strength |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-max-size |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-min-size |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-name |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-nat-size |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-strength |![](/content-docs/asset_files/images/checklist-implement.png)|||
