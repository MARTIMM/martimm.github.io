...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Popover.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Popover.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Popover.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-popover |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-autohide |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-cascade-popdown |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-has-arrow |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-pointing-to |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-autohide |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-cascade-popdown |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-has-arrow |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-pointing-to |![](/content-docs/asset_files/images/checklist-ok.png)|||
