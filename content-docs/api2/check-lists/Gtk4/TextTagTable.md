...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|TextTagTable.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|TextTagTable.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|TextTagTable.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-texttagtable |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| foreach |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-size |![](/content-docs/asset_files/images/checklist-ok.png)|||
| lookup |![](/content-docs/asset_files/images/checklist-ok.png)|||
