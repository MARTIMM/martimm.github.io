...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|GridView.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|GridView.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|GridView.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-gridview |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-max-columns |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-min-columns |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| set-max-columns |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-min-columns |![](/content-docs/asset_files/images/checklist-ok.png)|||
