...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Paned.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Paned.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Paned.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-paned |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-end-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-position |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-resize-end-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-resize-start-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-shrink-end-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-shrink-start-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-start-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-wide-handle |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-end-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-position |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-resize-end-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-resize-start-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-shrink-end-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-shrink-start-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-start-child |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-wide-handle |![](/content-docs/asset_files/images/checklist-ok.png)|||
