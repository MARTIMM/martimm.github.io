...
## Gnome::Gtk4::SizeGroup

||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|SizeGroup.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|SizeGroup.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|SizeGroup.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-sizegroup |![](/content-docs/asset_files/images/checklist-implement.png)|||
...
|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| add-widget |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-mode |![](/content-docs/asset_files/images/checklist-implement.png)|||
| get-widgets |![](/content-docs/asset_files/images/checklist-implement.png)|||
| remove-widget |![](/content-docs/asset_files/images/checklist-implement.png)|||
| set-mode |![](/content-docs/asset_files/images/checklist-implement.png)|||
