...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|PasswordEntry.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|PasswordEntry.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|PasswordEntry.rakutest|0 tests|

### Constructors

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| new-passwordentry |![](/content-docs/asset_files/images/checklist-ok.png)|||
...
| get-show-peek-icon |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-extra-menu |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-show-peek-icon |![](/content-docs/asset_files/images/checklist-ok.png)|||
