...
||State|Name|Tests|
|-|-|-|-|
|Module generated|![](/content-docs/asset_files/images/checklist-implement.png)|Gesture.rakumod
|Documentation corrected|![](/content-docs/asset_files/images/checklist-implement.png)|Gesture.rakudoc
|Tests completed|![](/content-docs/asset_files/images/checklist-implement.png)|Gesture.rakutest|0 tests|

### Methods

|Routine|State¹|Version²|Deprecated³|
|-------|-|----------|-------|
| get-bounding-box |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-bounding-box-center |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-device |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-group |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-last-event |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-last-updated-sequence |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-point |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-sequence-state |![](/content-docs/asset_files/images/checklist-ok.png)|||
| get-sequences |![](/content-docs/asset_files/images/checklist-ok.png)|||
| group |![](/content-docs/asset_files/images/checklist-ok.png)|||
| handles-sequence |![](/content-docs/asset_files/images/checklist-ok.png)|||
| is-active |![](/content-docs/asset_files/images/checklist-ok.png)|||
| is-grouped-with |![](/content-docs/asset_files/images/checklist-ok.png)|||
| is-recognized |![](/content-docs/asset_files/images/checklist-ok.png)|||
| set-sequence-state |![](/content-docs/asset_files/images/checklist-ok.png)![](/content-docs/asset_files/images/checklist-deprecated.png)||4.10. |
| set-state |![](/content-docs/asset_files/images/checklist-ok.png)|||
| ungroup |![](/content-docs/asset_files/images/checklist-ok.png)|||
